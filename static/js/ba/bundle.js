!function (e, t) {
    ...
    console.log(o), $(".checkboxes .brand").each(function () {
    ...
    }), console.log("checkCookieFilter()", o), o.categories.length && setTimeout(function () {
        $(".cat-title--main").click(), $(".cat-title--main").next().find(".cat-title").click()
    }, 100), (o.categories.length || o.brands.length) && t(), $(".catalog-page .filters .cat-title").on("click", function (e) {
        e.preventDefault(), $(this).toggleClass("active").next().slideToggle("fast")
    }), $(".catalog-page .filters .cat-item .delete, .catalog-page .filters .cat-title-item .delete").on("click", function (i) {
        ...
        var n = $(this).data("id");
        console.log("delete", n), e(n) && (o.categories.splice(o.categories.indexOf(n), 1), console.log("cat removed", o.categories), t())
            ...
            success: function (e) {
                ymaps.ready(function () {
                    ...
                    e = new ymaps.Map("map", {
                        ...
                        zoom: 15
                    }), t = new ymaps.Placemark([61.241708, 73.400976], {balloonContent: "Врачебный офис+"}, {
